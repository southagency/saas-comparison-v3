...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-orange-400 via-orange-300 to-yellow-200 text-white py-20">
      <div className="container mx-auto px-4 relative z-10">
        <h2 className="text-4xl font-bold mb-6 text-center text-gray-800">SaaSカンパニーで最適なSaaSを見つけよう</h2>
